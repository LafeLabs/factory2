...
<div id = "filescroll">
    ...
    <div class = "html file">html/bars.txt</div>
    <div class = "css file">css/bars.txt</div>
    ...
    <div class = "html file">html/uploader.txt</div>
    <div class = "php file">php/combiner.txt</div>
    <div class = "html file">html/combiner.txt</div>
    <div class = "php file">php/aligner.txt</div>
    <div class = "html file">html/aligner.txt</div>
    <div class = "php file">php/linker.txt</div>
    <div class = "html file">html/linker.txt</div>
    <div class = "php file">php/publisher.txt</div>
    <div class = "html file">html/publisher.txt</div>
    <div class = "php file">php/navigator.txt</div>
    <div class = "html file">html/navigator.txt</div>
